...
<br><br>
<h1 align ="center"><font color="Orange">INACTIVE TRAINEE LIST</font></h1><br>
<%
 ReportDAO pdao = new ReportDAO();
 ArrayList<InactiveTrainee> alc = pdao.getAllInactiveTrainee();
 Iterator<InactiveTrainee> itr = alc.iterator();
%>
<div class = "table" >
<table id = "example" class ="table"><br></br>
<a href="DownloadInactiveTrainee" class="btn btn-success" style="position:absolute;left:700px;top:200px;">Download<span class="glyphicon glyphicon-download-alt"></span></a>&nbsp;&nbsp;&nbsp;
<br></br>
<thead>
<tr>
                ...
                <td><b>Reason</b> <span id = "sort" class = "glyphicon glyphicon-sort"></span></td>
               
</tr>
</thead>
 <% while(itr.hasNext()) {
                InactiveTrainee cb = itr.next();
                out.print("<tr>");
                out.print("<td>" + cb.getTraineeId());
                out.print("<td>" + cb.getName());
                out.print("<td>" + cb.getReason());
                out.print("</tr>");
   }
