...
<br><br>
<h1 align ="center"><font color = "Orange">CHANGE PASSWORD</font></h1><br>
...
<input type="password" id="password" name="opassword" placeholder = "Enter Password" required>

<label for="website">New Password:</label>
<input type="password" id="password" name="npassword" placeholder = "Enter Password" required>
<div id="lower">
