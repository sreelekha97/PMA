...
<br><br>
<h1 align ="center"><font color="Orange">TRAINEE HISTORY</font></h1><br>
<%
 ReportDAO pdao = new ReportDAO();
 ArrayList<TraineeHistory> alc = pdao.getTraineeHistory();
 Iterator<TraineeHistory> itr = alc.iterator();
%>
<div class = "table" >
<table id = "example" class ="table"><br></br>
<a href = "DownloadTraineeHistory" class="btn btn-success" style="margin-right: 7px;">Download<span class="glyphicon glyphicon-download-alt"></span></a>
<br></br>
<thead>
<tr>
